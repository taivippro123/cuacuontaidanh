    ...
    <>
      ...
      {loading ? (
        <div className="flex items-center justify-center py-40">
          <p className="text-lg text-gray-5">Loading product...</p>
        </div>
      ) : !product ? (
        <div className="flex items-center justify-center py-40">
                ...
                <div className="max-w-[539px] w-full">
                  ...
                  <form onSubmit={(e) => e.preventDefault()}>
                    ...
                    <div className="flex flex-wrap items-center gap-4.5">
                      <Link
                        href="/contact"
                        className="inline-flex font-medium text-white bg-blue py-3 px-7 rounded-md ease-out duration-200 hover:bg-blue-dark whitespace-nowrap"
                      >
                        Liên hệ đặt hàng
                      </Link>
                    </div>
