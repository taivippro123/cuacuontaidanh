          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8 px-4 sm:px-7.5 xl:pl-12.5 xl:pr-14 py-11">
            <div className="max-w-[491px] w-full">
              <h2 className="max-w-[399px] text-white font-bold text-lg sm:text-xl xl:text-heading-4 mb-3">
                Đừng bỏ lỡ các xu hướng và ưu đãi mới nhất
              </h2>
              <p className="text-white">
                Đăng ký để nhận thông báo về các ưu đãi và khuyến mãi mới nhất từ chúng tôi
              </p>
            </div>
              ...
              <form>
                <div className="flex flex-col sm:flex-row sm:items-stretch gap-4">
                  <input
                    ...
                    className="w-full sm:min-w-0 sm:flex-1 bg-gray-1 border border-gray-3 outline-none rounded-md placeholder:text-dark-4 py-3 px-5"
                  />
                  <button
                    type="submit"
                    className="inline-flex shrink-0 whitespace-nowrap items-center justify-center py-3 px-7 text-white bg-blue font-medium rounded-md ease-out duration-200 hover:bg-blue-dark"
                  >
                    Đăng ký
                  </button>
                </div>
